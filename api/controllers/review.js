...
reviewsRouter.get("/user/:id/reviews", async (req, res) => {
...
reviewsRouter.get("/residents/:id/reviews", async (req, res) => {
...
reviewsRouter.post("/address/:id/review/new", async (req, res) => {
  const body = req.body
  try {
...
reviewsRouter.delete("/:id/delete", async (req, res) => {
  const reviewId = req.params.id
...
RETURNING *`
reviewsRouter.put("/:id/update", async (req, res) => {
  const reviewId = req.params.id
  const userId = req.auth.user_id
  const body = req.body
  try {
